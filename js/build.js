...
return t.on("404",function(){e.replace("!/"+i.pagePathPrefix+i.errorPage)}),t.on("current",function(){window.scrollTo(0,0)}),e.add("!/",function(){t.emit("current","index.md")}),e.add("!/"+i.pagePathPrefix+":name([^#]+)#:anchor",function(e){n===e.name?r(e.anchor):(t.emit("current",e.name),n=e.name,t.once("loaded",function(){r(e.anchor)}))}),e.add("!/"+i.pagePathPrefix+":name([^#]+)",function(e){t.emit("current",e.name)}),e.setDefault(function(e){t.emit("404",e)}),setTimeout(e.evaluateCurrent.bind(null,"!/"),0),t}},{events:213,"hash-brown-router":6}],5:[function(e,t,n){function r(e,t){e.location.replace(i(e.location.href)+"#"+t)}function i(e){var t=e.indexOf("#")
...
return e.addEventListener("hashchange",function(){n!==t.get()&&(n=t.get(),t.emit("hashchange"))}),t.go=o.bind(null,e),t.replace=r.bind(null,e),t.get=s.bind(null,e),t}},{events:213}],6:[function(e,t,n){function r(e,t,n){o(e,t.get(),n)}function i(e){var t=e.split("?")
...
var o
if(l.call(this),this.setMaxListeners(1/0),"function"==typeof e?(t="object"==typeof t?t:{},t.db=e,e=null):"object"==typeof e&&"function"==typeof e.db&&(t=e,e=null),"function"==typeof t&&(r=t,t={}),(!t||"function"!=typeof t.db)&&"string"!=typeof e){if(o=new k("Must provide a location for the database"),r)return n.nextTick(function(){r(o)})
...
if(n){try{i=s._codec.decodeValue(i,t)}catch(o){return n(new _(o))}n(null,i)}})}},i.prototype.put=function(e,t,n,i){var a,u,l=this
...
this._operations.forEach(function(e){t[e.method].apply(t,e.args)})},o.prototype._operation=function(e,t){return this._iterator?this._iterator[e].apply(this._iterator,t):void this._operations.push({method:e,args:t})},"next end".split(" ").forEach(function(e){o.prototype["_"+e]=function(){this._operation(e,arguments)}}),t.exports=i}).call(this,{isBuffer:e("/Users/saibotsivad/Development/npm_global/lib/node_modules/noddity-installer/node_modules/browserify/node_modules/insert-module-globals/node_modules/is-buffer/index.js")},e("_process"))},{"/Users/saibotsivad/Development/npm_global/lib/node_modules/noddity-installer/node_modules/browserify/node_modules/insert-module-globals/node_modules/is-buffer/index.js":215,_process:217,"abstract-leveldown":17,util:237}],15:[function(e,t,n){(function(e){function n(e){this._db=e,this._operations=[],this._written=!1}n.prototype._checkWritten=function(){if(this._written)throw new Error("write() already called on this batch")},n.prototype.put=function(e,t){this._checkWritten()
...
if(this._isBuffer(e)){if(0===e.length)return new Error(t+" cannot be an empty Buffer")}else if(""===String(e))return new Error(t+" cannot be an empty String")},t.exports.AbstractLevelDOWN=i,t.exports.AbstractIterator=s,t.exports.AbstractChainedBatch=a}).call(this,{isBuffer:e("/Users/saibotsivad/Development/npm_global/lib/node_modules/noddity-installer/node_modules/browserify/node_modules/insert-module-globals/node_modules/is-buffer/index.js")},e("_process"))},{"./abstract-chained-batch":15,"./abstract-iterator":16,"/Users/saibotsivad/Development/npm_global/lib/node_modules/noddity-installer/node_modules/browserify/node_modules/insert-module-globals/node_modules/is-buffer/index.js":215,_process:217,xtend:36}],18:[function(e,t,n){function r(e){this.opts=e||{},this.encodings=i}var i=e("./lib/encodings")
...
a.inherits(r,u),o(s(l.prototype),function(e){r.prototype[e]||(r.prototype[e]=l.prototype[e])})}).call(this,e("_process"))},{"./_stream_readable":28,"./_stream_writable":30,_process:217,"core-util-is":31,inherits:25}],27:[function(e,t,n){function r(e){return this instanceof r?void i.call(this,e):new r(e)}t.exports=r
...
return _(o,function(t){e.on(t,r.emit.bind(r,t))}),r._read=function(t){F("wrapped _read",t),n&&(n=!1,e.resume())},r},i._fromList=b}).call(this,e("_process"))},{"./_stream_duplex":26,_process:217,buffer:209,"core-util-is":31,events:213,inherits:25,isarray:32,stream:233,"string_decoder/":33,util:208}],29:[function(e,t,n){function r(e,t){this.afterTransform=function(e,n){return i(t,e,n)},this.needTransform=!1,this.transforming=!1,this.writecb=null,this.writechunk=null}function i(e,t,n){var r=e._transformState
r.transforming=!1
var i=r.writecb
...
e.emit("error",s),n.nextTick(function(){i(s)}),o=!1}return o}function u(e,t,n){return!e.objectMode&&e.decodeStrings!==!1&&k.isString(t)&&(t=new _(t,n)),t}function l(e,t,n,i,o){n=u(t,n,i),k.isBuffer(n)&&(i="buffer")
...
var E=e("stream")
k.inherits(o,E),o.prototype.pipe=function(){this.emit("error",new Error("Cannot pipe. Not readable."))},o.prototype.write=function(e,t,n){var r=this._writableState,i=!1
return k.isFunction(t)&&(n=t,t=null),k.isBuffer(e)?t="buffer":t||(t=r.defaultEncoding),k.isFunction(n)||(n=function(){}),r.ended?s(this,r,n):a(this,r,e,n)&&(r.pendingcb++,i=l(this,r,e,t,n)),i},o.prototype.cork=function(){var e=this._writableState
...
t.sequentialize(e,function(e){e(null,t._keys.length)})},n.LocalStorage=r}).call(this,{isBuffer:e("/Users/saibotsivad/Development/npm_global/lib/node_modules/noddity-installer/node_modules/browserify/node_modules/insert-module-globals/node_modules/is-buffer/index.js")})},{"./localstorage-core":39,"./taskqueue":49,"./utils":50,"/Users/saibotsivad/Development/npm_global/lib/node_modules/noddity-installer/node_modules/browserify/node_modules/insert-module-globals/node_modules/is-buffer/index.js":215,d64:46}],41:[function(e,t,n){(function(e){function n(e){this._db=e,this._operations=[],this._written=!1}n.prototype._checkWritten=function(){if(this._written)throw new Error("write() already called on this batch")},n.prototype.put=function(e,t){this._checkWritten()
...
if(null===e||void 0===e)return new Error(t+" cannot be `null` or `undefined`")
if(this._isBuffer(e)){if(0===e.length)return new Error(t+" cannot be an empty Buffer")}else if(""===String(e))return new Error(t+" cannot be an empty String")},t.exports.AbstractLevelDOWN=i,t.exports.AbstractIterator=s,t.exports.AbstractChainedBatch=a}).call(this,{isBuffer:e("/Users/saibotsivad/Development/npm_global/lib/node_modules/noddity-installer/node_modules/browserify/node_modules/insert-module-globals/node_modules/is-buffer/index.js")},e("_process"))},{"./abstract-chained-batch":41,"./abstract-iterator":42,"/Users/saibotsivad/Development/npm_global/lib/node_modules/noddity-installer/node_modules/browserify/node_modules/insert-module-globals/node_modules/is-buffer/index.js":215,_process:217,xtend:44}],44:[function(e,t,n){arguments[4][10][0].apply(n,arguments)},{dup:10}],45:[function(e,t,n){"use strict"
...
return u("change",g,d,"post changed"),u("change",v,d,"index changed"),v.on("change",v.getPosts),m.getPost=g.getPost,m.getPosts=o,m.allPostsAreLoaded=v.allPostsAreLoaded,m.stop=f,m.refreshPost=g.refresh,m}},{"./lib/index_manager.js":52,"./lib/post_manager.js":53,"./lib/reflect.js":54,events:213,extend:55,"noddity-retrieval":59,subleveldown:170,"weak-type-wizard":97}],52:[function(e,t,n){function r(e,t){var n=e&&t&&e.metadata&&t.metadata&&e.metadata.date&&t.metadata.date
...
return c.unref&&c.unref(),a.touch=a.emit.bind(a,"touch"),a.forget=a.emit.bind(a,"forget"),a.stop=function(){clearInterval(c)},n.nextTick(l),a}}).call(this,e("_process"))},{_process:217,events:213}],58:[function(e,t,n){arguments[4][10][0].apply(n,arguments)},{dup:10}],59:[function(e,t,n){(function(n){var r=e("superagent"),i=e("url"),o=e("text-metadata-parser")
...
return n.filename=e,n},n)}}}}).call(this,e("_process"))},{_process:217,superagent:60,"text-metadata-parser":95,url:235}],60:[function(e,t,n){function r(){}function i(e){var t={}.toString.call(e)
...
return!1}function l(e){this.source=e,this.result="",this.checkpoint=0}function c(e,t,n,r){var i,o,a,c,f,m,g,v,y,b,w,_,k,E,x,D,A,C,S,F,B
if(0===t.length)return void(e.dump="''")
if(-1!==te.indexOf(t))return void(e.dump="'"+t+"'")
for(i=!0,o=t.length?t.charCodeAt(0):0,a=L===o||L===t.charCodeAt(t.length-1),(W===o||K===o||Y===o||Z===o)&&(i=!1),a?(i=!1,c=!1,f=!1):(c=!r,f=!r),m=!0,g=new l(t),v=!1,y=0,b=0,w=e.indent*n,_=80,40>w?_-=w:_=40,E=0;E<t.length;E++){if(k=t.charCodeAt(E),i){if(p(k))continue
i=!1}m&&k===q&&(m=!1),x=ee[k],D=d(k),(x||D)&&(k!==j&&k!==P&&k!==q?(c=!1,f=!1):k===j&&(v=!0,m=!1,E>0&&(A=t.charCodeAt(E-1),A===L&&(f=!1,c=!1)),c&&(C=E-y,y=E,C>b&&(b=C))),k!==P&&(m=!1),g.takeUpTo(E),g.escapeChar())}if(i&&u(e,t)&&(i=!1),S="",(c||f)&&(F=0,t.charCodeAt(t.length-1)===j&&(F+=1,t.charCodeAt(t.length-2)===j&&(F+=1)),0===F?S="-":2===F&&(S="+")),f&&_>b&&(c=!1),v||(f=!1),i)e.dump=t
else if(m)e.dump="'"+t+"'"
else if(c)B=h(t,_),e.dump=">"+S+"\n"+s(B,w)
...
throw new A("unacceptable kind of an object to dump "+s)}"?"!==e.tag&&c(e,e.dump,t,o)}null!==e.tag&&"?"!==e.tag&&(e.dump="!<"+e.tag+"> "+e.dump)}return!0}function _(e,t){var n,r,i=[],o=[]
...
return t=e.input.charCodeAt(n),45!==t&&46!==t||e.input.charCodeAt(n+1)!==t||e.input.charCodeAt(n+2)!==t||(n+=3,t=e.input.charCodeAt(n),0!==t&&!o(t))?!1:!0}function k(e,t){1===t?e.result+=" ":t>1&&(e.result+=q.repeat("\n",t-1))}function E(e,t,n){var a,u,l,c,h,f,p,d,m,v=e.kind,y=e.result
...
for(e.kind="scalar",e.result="",l=c=e.position,h=!1;0!==m;){if(58===m){if(u=e.input.charCodeAt(e.position+1),o(u)||n&&s(u))break}else if(35===m){if(a=e.input.charCodeAt(e.position-1),o(a))break}else{if(e.position===e.lineStart&&_(e)||n&&s(m))break
...
break}}h&&(g(e,l,c,!1),k(e,e.line-f),l=c=e.position,h=!1),i(m)||(c=e.position+1),m=e.input.charCodeAt(++e.position)}return g(e,l,c,!1),e.result?!0:(e.kind=v,e.result=y,!1)}function x(e,t){var n,i,o
...
n=i=e.position}else r(c)?(g(e,n,i,!0),k(e,w(e,!1,t)),n=i=e.position):e.position===e.lineStart&&_(e)?d(e,"unexpected end of the document within a double quoted scalar"):(e.position++,i=e.position)}d(e,"unexpected end of the stream within a double quoted scalar")}function A(e,t){var n,r,i,s,a,u,l,c,h,f,p,m=!0,g=e.tag,v=e.anchor
...
s.push(e.input.slice(t,e.position))}0!==a&&b(e),H.call(ae,n)?ae[n](e,n,s):m(e,'unknown document directive "'+n+'"')}return w(e,!0,-1),0===e.lineIndent&&45===e.input.charCodeAt(e.position)&&45===e.input.charCodeAt(e.position+1)&&45===e.input.charCodeAt(e.position+2)?(e.position+=3,w(e,!0,-1)):l&&d(e,"directives end mark is expected"),O(e,e.lineIndent-1,G,!1,!0),w(e,!0,-1),e.checkLineBreaks&&ee.test(e.input.slice(u,e.position))&&m(e,"non-ASCII line breaks are interpreted as content"),e.documents.push(e.result),e.position===e.lineStart&&_(e)?void(46===e.input.charCodeAt(e.position)&&(e.position+=3,w(e,!0,-1))):void(e.position<e.length-1&&d(e,"end of the stream or a document separator is expected"))}function I(e,t){e=String(e),t=t||{},0!==e.length&&(10!==e.charCodeAt(e.length-1)&&13!==e.charCodeAt(e.length-1)&&(e+="\n"),65279===e.charCodeAt(0)&&(e=e.slice(1)))
var n=new f(e,t)
...
return(t>1114111||"}"!==e)&&te(),u(t)}function _(e){var t,n,r
return t=nn.charCodeAt(e),t>=55296&&56319>=t&&(r=nn.charCodeAt(e+1),r>=56320&&57343>=r&&(n=t,t=1024*(n-55296)+r-56320+65536)),t}function k(){var e,t,n
for(e=_(on),n=u(e),on+=n.length,92===e&&(117!==nn.charCodeAt(on)&&te(),++on,"{"===nn[on]?(++on,t=w()):(t=b("u"),e=t.charCodeAt(0),t&&"\\"!==t&&l(e)||te()),n=t);gn>on&&(e=_(on),c(e));)t=u(e),n+=t,on+=t.length,92===e&&(n=n.substr(0,n.length-1),117!==nn.charCodeAt(on)&&te(),++on,"{"===nn[on]?(++on,t=w()):(t=b("u"),e=t.charCodeAt(0),t&&"\\"!==t&&c(e)||te()),n+=t)
return n}function E(){var e,t
for(e=on++;gn>on;){if(t=nn.charCodeAt(on),92===t)return on=e,k()
if(t>=55296&&57343>t)return on=e,k()
if(!c(t))break;++on}return nn.slice(e,on)}function x(){var e,t,n
return e=on,t=92===nn.charCodeAt(on)?k():E(),n=1===t.length?Gt.Identifier:d(t)?Gt.Keyword:"null"===t?Gt.NullLiteral:"true"===t||"false"===t?Gt.BooleanLiteral:Gt.Identifier,{type:n,value:t,lineNumber:sn,lineStart:an,start:e,end:on}}function D(){var e,t
...
return on>=gn?{type:Gt.EOF,lineNumber:sn,lineStart:an,start:on,end:on}:(e=nn.charCodeAt(on),l(e)?(t=x(),rn&&f(t.value)&&(t.type=Gt.Keyword),t):40===e||41===e||59===e?D():39===e||34===e?T():46===e?n(nn.charCodeAt(on+1))?B():D():n(e)?B():bn.tokenize&&47===e?M():96===e||125===e&&"${"===yn.curlyStack[yn.curlyStack.length-1]?j():e>=55296&&57343>e&&(e=_(on),l(e))?x():D())}function U(){var e,t,n,r
...
return vn.type!==Gt.Punctuator?!1:(e=vn.value,"="===e||"*="===e||"/="===e||"%="===e||"+="===e||"-="===e||"<<="===e||">>="===e||">>>="===e||"&="===e||"^="===e||"|="===e)}function ce(){return 59===nn.charCodeAt(fn)||se(";")?void z():void(un||(ln=fn,cn=pn,hn=dn,vn.type===Gt.EOF||se("}")||te(vn)))}function he(e){var t,n=wn,r=_n,i=kn
return wn=!0,_n=!0,kn=null,t=e(),null!==kn&&te(kn),wn=n,_n=r,kn=i,t}function fe(e){var t,n=wn,r=_n,i=kn
return wn=!0,_n=!0,kn=null,t=e(),wn=wn&&n,_n=_n&&r,kn=i||kn,t}function pe(e,t){var n,r,i=new Y,o=[]
...
if(!se(":"))return e.push(r),o.finishProperty("init",n,!1,n,!1,!0)}else n=_e(e,t)
...
for(re("[");!se("]");)se(",")?(z(),t.push(null)):se("...")?(e=new Y,z(),e.finishSpreadElement(fe($e)),se("]")||(_n=wn=!1,re(",")),t.push(e)):(t.push(fe($e)),se("]")||re(","))
return z(),n.finishArrayExpression(t)}function be(e,t,n){var r,i
return _n=wn=!1,r=rn,i=he(xt),rn&&t.firstRestricted&&ne(t.firstRestricted,t.message),rn&&t.stricted&&ne(t.stricted,t.message),rn=r,e.finishFunctionExpression(null,t.params,t.defaults,i,n)}function we(){var e,t,n=new Y,r=yn.allowYield
return yn.allowYield=!1,e=Ct(),yn.allowYield=r,yn.allowYield=!1,t=be(n,e,!1),yn.allowYield=r,t}function _e(){var e,t,n=new Y
...
case Gt.Punctuator:if("["===e.value)return t=he($e),re("]"),t}te(e)}function ke(){switch(vn.type){case Gt.Identifier:case Gt.StringLiteral:case Gt.BooleanLiteral:case Gt.NullLiteral:case Gt.NumericLiteral:case Gt.Keyword:return!0
case Gt.Punctuator:return"["===vn.value}return!1}function Ee(e,t,n,r){var i,o,s,a,u=yn.allowYield
if(e.type===Gt.Identifier){if("get"===e.value&&ke())return n=se("["),t=_e(),s=new Y,re("("),re(")"),yn.allowYield=!1,i=be(s,{params:[],defaults:[],stricted:null,firstRestricted:null,message:null},!1),yn.allowYield=u,r.finishProperty("get",t,n,i,!1,!1)
if("set"===e.value&&ke())return n=se("["),t=_e(),s=new Y,re("("),o={params:[],defaultCount:0,defaults:[],firstRestricted:null,paramSet:{}},se(")")?ne(vn):(yn.allowYield=!1,At(o),yn.allowYield=u,0===o.defaultCount&&(o.defaults=[])),re(")"),yn.allowYield=!1,i=be(s,o,!1),yn.allowYield=u,r.finishProperty("set",t,n,i,!1,!1)}else if(e.type===Gt.Punctuator&&"*"===e.value&&ke())return n=se("["),t=_e(),s=new Y,yn.allowYield=!0,a=Ct(),yn.allowYield=u,yn.allowYield=!1,i=be(s,a,!0),yn.allowYield=u,r.finishProperty("init",t,n,i,!0,!1)
return t&&se("(")?(i=we(),r.finishProperty("init",t,n,i,!0,!1)):null}function xe(e){var t,n,r,i,o,s=vn,a=new Y
return t=se("["),se("*")?z():n=_e(),(r=Ee(s,n,t,a))?r:(n||te(vn),t||(i=n.type===Qt.Identifier&&"__proto__"===n.name||n.type===Qt.Literal&&"__proto__"===n.value,e.value&&i&&X(en.DuplicateProtoProperty),e.value|=i),se(":")?(z(),o=fe($e),a.finishProperty("init",n,t,o,!1,!1)):s.type===Gt.Identifier?se("=")?(kn=vn,z(),o=he($e),a.finishProperty("init",n,t,new $(s).finishAssignmentPattern(n,o),!1,!0)):a.finishProperty("init",n,t,n,!1,!0):void te(vn))}function De(){var e=[],t={value:!1},n=new Y
...
if(wn=!0,e=fe($e),se(",")){for(_n=!1,t=[e];gn>fn&&se(",");){if(z(),se("...")){for(wn||te(vn),t.push(st(i)),re(")"),se("=>")||re("=>"),wn=!1,r=0;r<t.length;r++)Ae(t[r])
...
else if(e===Gt.StringLiteral||e===Gt.NumericLiteral)_n=wn=!1,rn&&vn.octal&&ne(vn,en.StrictOctalLiteral),n=r.finishLiteral(z())
else if(e===Gt.Keyword){if(!rn&&yn.allowYield&&ae("yield"))return je()
if(_n=wn=!1,ae("function"))return Ft()
if(ae("this"))return z(),r.finishThisExpression()
if(ae("class"))return jt()
te(z())}else e===Gt.BooleanLiteral?(_n=wn=!1,t=z(),t.value="true"===t.value,n=r.finishLiteral(t)):e===Gt.NullLiteral?(_n=wn=!1,t=z(),t.value=null,n=r.finishLiteral(t)):se("/")||se("/=")?(_n=wn=!1,on=fn,t="undefined"!=typeof bn.tokens?R():P(),z(),n=r.finishLiteral(t)):e===Gt.Template?n=Se():te(z())
...
te(vn)}return e=he(Re),t=se("(")?Te():[],_n=wn=!1,n.finishNewExpression(e,t)}function Pe(){var e,t,n,r,i,o=yn.allowIn
for(i=vn,yn.allowIn=!0,ae("super")&&yn.inFunctionBody?(t=new Y,z(),t=t.finishSuper(),se("(")||se(".")||se("[")||te(vn)):t=fe(ae("new")?Ie:Be);;)if(se("."))wn=!1,_n=!0,r=Oe(),t=new $(i).finishMemberExpression(".",t,r)
else if(se("("))wn=!1,_n=!1,n=Te(),t=new $(i).finishCallExpression(t,n)
else if(se("["))wn=!1,_n=!0,r=Le(),t=new $(i).finishMemberExpression("[",t,r)
...
for(t(yn.allowIn,"callee of new expression always allow in keyword."),i=vn,ae("super")&&yn.inFunctionBody?(n=new Y,z(),n=n.finishSuper(),se("[")||se(".")||te(vn)):n=fe(ae("new")?Ie:Be);;)if(se("["))wn=!1,_n=!0,r=Le(),n=new $(i).finishMemberExpression("[",n,r)
else if(se("."))wn=!1,_n=!0,r=Oe(),n=new $(i).finishMemberExpression(".",n,r)
else{if(vn.type!==Gt.Template||!vn.head)break
e=Se(),n=new $(i).finishTaggedTemplateExpression(n,e)}return n}function Ne(){var e,t,n=vn
return e=fe(Pe),un||vn.type!==Gt.Punctuator||(se("++")||se("--"))&&(rn&&e.type===Qt.Identifier&&p(e.name)&&X(en.StrictLHSPostfix),_n||X(en.InvalidLHSInAssignment),_n=wn=!1,t=z(),e=new $(n).finishPostfixExpression(t.value,e)),e}function Me(){var e,t,n
return vn.type!==Gt.Punctuator&&vn.type!==Gt.Keyword?t=Ne():se("++")||se("--")?(n=vn,e=z(),t=fe(Me),rn&&t.type===Qt.Identifier&&p(t.name)&&X(en.StrictLHSPrefix),_n||X(en.InvalidLHSInAssignment),t=new $(n).finishUnaryExpression(e.value,t),_n=wn=!1):se("+")||se("-")||se("~")||se("!")?(n=vn,e=z(),t=fe(Me),t=new $(n).finishUnaryExpression(e.value,t),_n=wn=!1):ae("delete")||ae("void")||ae("typeof")?(n=vn,e=z(),t=fe(Me),t=new $(n).finishUnaryExpression(e.value,t),rn&&"delete"===t.operator&&t.argument.type===Qt.Identifier&&X(en.StrictDelete),_n=wn=!1):t=Ne(),t}function qe(e,t){var n=0
...
for(_n=wn=!1,r.prec=i,z(),t=[e,vn],s=he(Me),o=[u,r,s];(i=qe(vn,yn.allowIn))>0;){for(;o.length>2&&i<=o[o.length-2].prec;)s=o.pop(),a=o.pop().value,u=o.pop(),t.pop(),n=new $(t[t.length-1]).finishBinaryExpression(a,u,s),o.push(n)
...
return i=vn,e=fe(Ue),se("?")&&(z(),t=yn.allowIn,yn.allowIn=!0,n=he($e),yn.allowIn=t,re(":"),r=he($e),e=new $(i).finishConditionalExpression(e,n,r),_n=wn=!1),e}function We(){return se("{")?xt():he($e)}function Ve(e,n){var r
...
return i=vn,e=vn,!yn.allowYield&&ae("yield")?Ye():(t=ze(),t.type===Xt.ArrowParameterPlaceHolder||se("=>")?(_n=wn=!1,r=He(t),r?(kn=null,Ke(r,new $(i))):t):(le()&&(_n||X(en.InvalidLHSInAssignment),rn&&t.type===Qt.Identifier&&(p(t.name)&&ne(e,en.StrictLHSAssignment),f(t.name)&&ne(e,en.StrictReservedWord)),se("=")?Ae(t):_n=wn=!1,e=z(),n=he($e),t=new $(i).finishAssignmentExpression(e.value,t,n),kn=null),t))}function Ge(){var e,t,n=vn
...
else if(i=vn,yn.allowIn=!1,t=fe($e),yn.allowIn=p,ae("in"))_n||X(en.InvalidLHSInForIn),z(),Ae(t),a=t,u=Ge(),t=null
else if(ue("of"))_n||X(en.InvalidLHSInForLoop),z(),Ae(t),a=t,u=$e(),t=null,n=!1
...
return rn&&p(e.name)&&X(en.StrictCatchVariable),re(")"),r=Qe(),s.finishCatchClause(e,r)}function _t(e){var t,n=null,r=null
return oe("try"),t=Qe(),ae("catch")&&(n=wt()),ae("finally")&&(z(),r=Qe()),n||r||Q(en.NoCatchOrFinally),e.finishTryStatement(t,n,r)}function kt(e){return oe("debugger"),ce(),e.finishDebuggerStatement()}function Et(){var e,t,n,r,i=vn.type
if(i===Gt.EOF&&te(vn),i===Gt.Punctuator&&"{"===vn.value)return Qe()
if(_n=wn=!0,r=new Y,i===Gt.Punctuator)switch(vn.value){case";":return at(r)
case"(":return ut(r)}else if(i===Gt.Keyword)switch(vn.value){case"break":return dt(r)
case"continue":return pt(r)
case"debugger":return kt(r)
case"do":return ct(r)
...
for(e=new Y,re("{"),r=[];!se("}");)se(";")?z():(i=new Y,t=vn,n=!1,o=se("["),se("*")?z():(s=_e(),"static"===s.name&&(ke()||se("*"))&&(t=vn,n=!0,o=se("["),se("*")?z():s=_e())),i=Ee(t,s,o,i),i?(i["static"]=n,"init"===i.kind&&(i.kind="method"),n?i.computed||"prototype"!==(i.key.name||i.key.value.toString())||te(t,en.StaticPrototype):i.computed||"constructor"!==(i.key.name||i.key.value.toString())||(("method"!==i.kind||!i.method||i.value.generator)&&te(t,en.ConstructorSpecialMethod),a?te(t,en.DuplicateConstructor):a=!0,i.kind="constructor"),i.type=Qt.MethodDefinition,delete i.method,delete i.shorthand,r.push(i)):te(vn))
...
try{n=Ht(),"undefined"!=typeof bn.comments&&(n.comments=bn.comments),"undefined"!=typeof bn.tokens&&(Kt(),n.tokens=bn.tokens),"undefined"!=typeof bn.errors&&(n.errors=bn.errors)}catch(i){throw i}finally{bn={}}return n}var Gt,Zt,Jt,Qt,Xt,en,tn,nn,rn,on,sn,an,un,ln,cn,hn,fn,pn,dn,mn,gn,vn,yn,bn,wn,_n,kn
...
t.exports=function(t,n){return{mixinHtml:a.bind(null,n),makeNewMixinObject:i,mixinRenderedHtmlEmitter:l,parseTemplate:e("./parseTemplate"),mixinChildPosts:s.bind(null,t.getPost),updateEmitterMixin:g(t),mixinTemplateRactive:c,mixinTeardownChildren:h,renderChildrenIntoTemplates:u}}}).call(this,e("_process"))},{"./parseTemplate":166,"./templateToolbox.js":167,"./updateEmitterMixin.js":168,_process:217,cheerio:100,events:213,ractive:169,xtend:164}],103:[function(e,t,n){"use strict"
...
return o(y,t)?y[t]:35===t.charCodeAt(0)&&v.test(t)&&(n="x"===t[1].toLowerCase()?parseInt(t.slice(2),16):parseInt(t.slice(1),10),u(n))?l(n):e}function h(e){return e.indexOf("&")<0?e:e.replace(g,c)}function f(e){return _[e]}function p(e){return b.test(e)?e.replace(w,f):e}var d=Object.prototype.hasOwnProperty,m=/\\([\\!"#$%&'()*+,.\/:;<=>?@[\]^_`{|}~-])/g,g=/&([a-z#][a-z0-9]{1,31});/gi,v=/^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))/i,y=e("./entities"),b=/[&<>"]/,w=/[&<>"]/g,_={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"}
...
t.exports=function(e){var t,n,a,l,c,h,f,p,d,m,g,v,y,b,w,_,k
if(e.options.typographer)for(k=[],w=e.tokens.length-1;w>=0;w--)if("inline"===e.tokens[w].type)for(_=e.tokens[w].children,k.length=0,t=0;t<_.length;t++)if(n=_[t],"text"===n.type&&!o.test(n.text)){for(f=_[t].level,y=k.length-1;y>=0&&!(k[y].level<=f);y--);k.length=y+1,a=n.content,c=0,h=a.length
e:for(;h>c&&(s.lastIndex=c,l=s.exec(a));)if(p=!r(a,l.index-1),c=l.index+1,b="'"===l[0],d=!r(a,c),d||p){if(g=!d,v=!p)for(y=k.length-1;y>=0&&(m=k[y],!(k[y].level<f));y--)if(m.single===b&&k[y].level===f){m=k[y],b?(_[m.token].content=i(_[m.token].content,m.pos,e.options.quotes[2]),n.content=i(n.content,l.index,e.options.quotes[3])):(_[m.token].content=i(_[m.token].content,m.pos,e.options.quotes[0]),n.content=i(n.content,l.index,e.options.quotes[1])),k.length=y
continue e}g?k.push({token:t,pos:l.index,single:b,level:f}):v&&b&&(n.content=i(n.content,l.index,u))}else b&&(n.content=i(n.content,l.index,u))}}},{}],146:[function(e,t,n){"use strict"
...
t.exports=o},{"./numberOfOccurrances":165,"./templateToolbox":167,events:213,xtend:164}],167:[function(e,t,n){function r(e){return e.metadata.markdown!==!1?f.render(e.content):e.content}function i(){return"xxxxxxxxxxxx4xxxyxxxxxxxxxxxxxxx".replace(/[xy]/g,function(e){var t=16*Math.random()|0,n="x"==e?t:3&t|8
...
for(t=e.split("."),(n=Ua[t.length])||(n=_(t.length)),o=[],r=function(e,n){return e?"*":t[n]},i=n.length;i--;)s=n[i].map(r).join("."),o.hasOwnProperty(s)||(o.push(s),o[s]=!0)
return o}function _(e){var t,n,r,i,o,s,a,u,l=""
...
r[o]=u}Ua[e]=r}return Ua[e]}function k(e,t,n,r){var i=e[t]
...
return ka(i,{selector:{value:t},live:{value:n},_isComponentQuery:{value:r},_test:{value:Au}}),n?(ka(i,{cancel:{value:Cu},_root:{value:e},_sort:{value:Bu},_makeDirty:{value:Tu},_remove:{value:ju},_dirty:{value:!1,writable:!0}}),i):i}function ce(e,t){var n,r
...
return t=e.pos,e.matchString("(")?(e.allowWhitespace(),n=Sh(e),n||e.error(Mc),e.allowWhitespace(),e.matchString(")")||e.error(qc),{t:_c,x:n}):null}function tt(e){var t,n,r
...
case _c:return"("+t(e.x)+")"
case bc:return t(e.x)+t(e.r)
case yc:return e.n?"."+e.n:"["+t(e.x)+"]"
case kc:return t(e.o[0])+"?"+t(e.o[1])+":"+t(e.o[2])
...
else if(o=Wh(e,t))i.n===Ac&&e.error("{{else}} not allowed in {{#unless}}"),a&&e.error("illegal {{elseif...}} after {{else}}"),l||(l=bt(r,i.n)),l.f.push({t:Zl,n:Dc,x:Fh(_t(c.concat(o.x))),f:s=[]}),c.push(wt(o.x))
else if(o=Uh(e,t))i.n===Ac&&e.error("{{else}} not allowed in {{#unless}}"),a&&e.error("there can only be one {{else}} block, at the end of a section"),a=!0,l?l.f.push({t:Zl,n:Dc,x:Fh(_t(c)),f:s=[]}):(l=bt(r,i.n),s=l.f)
else{if(o=e.read(ep),!o)break
s.push(o)}while(!h)
return l&&(i.n===Sc&&(i.n=Fc),i.l=l),Bh(r,i),i.f.length||delete i.f,i}function bt(e,t){var n
return t===Sc?(n={t:Zl,n:Dc,f:[]},Bh(wt(e),n)):(n={t:Zl,n:Ac,f:[]},Bh(e,n)),n}function wt(e){return e.t===wc&&"!"===e.s?e.o:{t:wc,s:"!",o:kt(e)}}function _t(e){return 1===e.length?e[0]:{t:Ec,s:"&&",o:[kt(e[0]),kt(_t(e.slice(1)))]}}function kt(e){return{t:_c,x:e}}function Et(e){var t,n,r,i,o
return t=e.pos,e.matchString(Jh)?(r=e.remaining(),i=r.indexOf(Qh),-1===i&&e.error("Illegal HTML - expected closing comment sequence ('-->')"),n=r.substr(0,i),e.pos+=i+3,o={t:tc,c:n},e.includeLinePositions&&(o.p=e.getLinePos(t)),o):null}function xt(e){return e.replace(kh,function(e,t){var n
return n="#"!==t[0]?wh[t]:"x"===t[1]?parseInt(t.substring(2),16):parseInt(t.substring(1),10),n?String.fromCharCode(Dt(n)):e})}function Dt(e){return e?10===e?32:128>e?e:159>=e?_h[e-128]:55296>e?e:57343>=e?65533:65535>=e?e:65533:65533}function At(e){return e.replace(Dh,"&amp;").replace(Eh,"&lt;").replace(xh,"&gt;")}function Ct(e){return"string"==typeof e}function St(e){return e.t===tc||e.t===nc}function Ft(e){return(e.t===Zl||e.t===Jl)&&e.f}function Bt(e,t,n,r,i){var s,a,u,l,c,h,f,p
...
return e.allowWhitespace(),(n=e.matchPattern(kf))?(t={name:n},r=Ot(e),null!=r&&(t.value=r),t):null}function Ot(e){var t,n,r,i
...
return e.text?e.text:e.fragments?e.fragments.map(function(e){return kn(e.items,t,n,r)}).join(""):(i=n+"-"+r++,s=e.keypath&&(o=e.root.viewmodel.wrapped[e.keypath.str])?o.value:e.getValue(),t[i]=s,"${"+i+"}")}).join("")}function En(){var e,t,n,r
...
if(/this/.test(e.toString())){_a(e,r,{value:Gp.call(e,t),configurable:!0})
for(i in e)e.hasOwnProperty(i)&&(e[r][i]=e[i])
return t._boundFunctions.push({fn:e,prop:r}),e[r]}return _a(e,"__ractive_nowrap",{value:e}),e.__ractive_nowrap}function Rn(e){return e.value}function Nn(e){return void 0!=e}function Mn(e){e.forceResolution()}function qn(e,t){function n(t){e.resolve(t)}function r(t){var n=e.keypath
...
for(r=this.nodes.length,n=0;r>n;n+=1)if(i=this.nodes[n],1===i.nodeType&&(fa(i,e)&&t.push(i),o=i.querySelectorAll(e)))for(s=o.length,a=0;s>a;a+=1)t.push(o[a])}function wr(){return this.rendered&&this.nodes[0]?this.nodes[0]:this.parentFragment.findNextNode(this)}function _r(e){return Td[e]||(Td[e]=ha(e))}function kr(e){var t,n,r
...
"id"===r?t=bm:"value"===r?"select"===i.name&&"value"===r?t=i.getAttribute("multiple")?dm:pm:"textarea"===i.name?t=km:null!=i.getAttribute("contenteditable")?t=_m:"input"===i.name&&(e=i.getAttribute("type"),t="file"===e?Ta:"radio"===e&&i.binding&&"name"===i.binding.name?gm:km):this.isTwoway&&"name"===r?"radio"===o.type?t=mm:"checkbox"===o.type&&(t=vm):"style"===r&&o.style.setAttribute?t=wm:"class"!==r||o.namespaceURI&&o.namespaceURI!==ra.html?this.useProperty&&(t=Em):t=ym,t||(t=xm),this.update=t,this.update()}function ei(e,t){var n=t?"svg":"div"
...
this.node&&(i=this.node._ractive)&&k(i,"keypath",e,t)}function Li(e){var t;(e.attributes.width||e.attributes.height)&&e.node.addEventListener("load",t=function(){var n=e.getAttribute("width"),r=e.getAttribute("height")
...
return"string"==typeof n?(i={},i[t+n]=r,i):"object"==typeof n?t?bo(n,e):n:void 0}),ry[e]}function _o(e){var t,n,r=[Ya]
...
a=_y(i,o),this.smartUpdate(e,n,a,t.length!==n.length)}function qo(e){return JSON.stringify(e)}function Uo(e){if(e===!0)return qo
...
this.resolvers.forEach(Y),_s(this),e._observers.forEach(G),e.fragment.unbind(),e.viewmodel.teardown(),e.fragment.rendered&&e.el.__ractive_instances__&&P(e.el.__ractive_instances__,e),Xy.fire(e)}function _s(e){var t,n
t=e.root
do(n=t._liveComponentQueries["_"+e.name])&&n._remove(e)
while(t=t.parent)}function ks(e){this.shouldDestroy=e,this.instance.unrender()}function Es(e){var t=this
...
default:throw new Error("Something very strange happened. Please file an issue at https://github.com/ractivejs/ractive/issues. Thanks!")}}function Ds(e,t){(!this.owner||this.owner.hasContext)&&k(this,"context",e,t),this.items.forEach(function(n){n.rebind&&n.rebind(e,t)})}function As(){var e
...
return _b.fire(this,e),t}function Ls(e){var t,n
...
var wa,_a,ka,Ea=null
try{Object.defineProperty({},"test",{value:0}),Xs&&Object.defineProperty(document.createElement("div"),"test",{value:0}),_a=Object.defineProperty}catch(xa){_a=function(e,t,n){e[t]=n.value}}try{try{Object.defineProperties({},{test:{value:0}})}catch(xa){throw xa}Xs&&Object.defineProperties(ha("div"),{test:{value:0}}),ka=Object.defineProperties}catch(xa){ka=function(e,t){var n
for(n in t)t.hasOwnProperty(n)&&_a(e,n,t[n])}}try{Object.create(null),wa=Object.create}catch(xa){wa=function(){var e=function(){}
...
var wu=bu,_u=ne,ku={stop:Ta},Eu=ie,xu=new nu("detach"),Du=oe,Au=se,Cu=function(){var e,t,n
...
Xs?(tl=document.createElement("style"),tl.type="text/css",nl=document.getElementsByTagName("head")[0],il=!1,rl=tl.styleSheet,el=function(){var e=wl+_l.map(function(e){return"\n/* {"+e.id+"} */\n"+e.styles}).join("\n")
rl?rl.cssText=e:tl.innerHTML=e,il||(nl.appendChild(tl),il=!0)},Xu={add:function(e){_l.push(e),kl=!0},apply:function(){kl&&(el(),kl=!1)}}):Xu={add:Ta,apply:Ta}
...
var Wl,Vl,Hl,Kl=El,Yl=1,$l=2,Gl=3,Zl=4,Jl=5,Ql=6,Xl=7,ec=8,tc=9,nc=10,rc=13,ic=14,oc=15,sc=16,ac=17,uc=18,lc=20,cc=21,hc=22,fc=23,pc=24,dc=25,mc=26,gc=27,vc=30,yc=31,bc=32,wc=33,_c=34,kc=35,Ec=36,xc=40,Dc=50,Ac=51,Cc=52,Sc=53,Fc=54,Bc=60,Tc=61,jc=ze,Oc=/^[^\s=]+/,Lc=/^\s+/,Ic=We,Pc=/^(\/(?:[^\n\r\u2028\u2029\/\\[]|\\.|\[(?:[^\n\r\u2028\u2029\]\\]|\\.)*])+\/(?:([gimuy])(?![a-z]*\2))*(?![a-zA-Z_$0-9]))/,Rc=Ve,Nc={t:nc,exclude:!0},Mc="Expected a JavaScript expression",qc="Expected closing paren",Uc=Ke,zc=/^(?:[+-]?)0*(?:(?:(?:[1-9]\d*)?\.\d+)|(?:(?:0|[1-9]\d*)\.)|(?:0|[1-9]\d*))(?:[eE][+-]?\d+)?/,Wc=Ye
...
mh=i}()
var yh,bh,wh,_h,kh,Eh,xh,Dh,Ah=mh,Ch=nt,Sh=rt,Fh=it,Bh=st,Th=/^[0-9][1-9]*$/,jh=ut,Oh=lt,Lh=ct,Ih=ht,Ph=ft,Rh=pt,Nh=dt,Mh=/^yield\s*/,qh=mt,Uh=gt,zh=/^\s*else\s*/,Wh=vt,Vh=/^\s*elseif\s+/,Hh={each:Cc,"if":Dc,"if-with":Fc,"with":Sc,unless:Ac},Kh=yt,Yh=/^\s*:\s*([a-zA-Z_$][a-zA-Z_$0-9]*)/,$h=/^\s*,\s*([a-zA-Z_$][a-zA-Z_$0-9]*)/,Gh=new RegExp("^("+Object.keys(Hh).join("|")+")\\b"),Zh=Et,Jh="<!--",Qh="-->"
...
for(n=t.length;n--;){if(r=e.indexOf(t[n]),!r)return 0;-1!==r&&(!i||i>r)&&(i=r)}return i||-1},_f=jt,kf=/^[^\s"'>\/=]+/,Ef=/^[^\s"'=<>`]+/
...
var bp=cp,wp=dn,_p=mn,kp=gn,Ep=vn,xp=yn,Dp=bn,Ap=wn,Cp=_n,Sp=kn,Fp=En,Bp=xn,Tp=Dn,jp=function(){return t(this.node)},Op=function(e){this.type=Yl,this.text=e.template}
...
if(null!=e&&""!==e){for(xd&&(i=Dd[t.tagName])?(r=_r("DIV"),r.innerHTML=i[0]+e+i[1],r=r.querySelector(".x"),"SELECT"===r.tagName&&(o=r.options[r.selectedIndex])):t.namespaceURI===ra.svg?(r=_r("DIV"),r.innerHTML='<svg class="x">'+e+"</svg>",r=r.querySelector(".x")):(r=_r(t.tagName),r.innerHTML=e,"SELECT"===r.tagName&&(o=r.options[r.selectedIndex]));s=r.firstChild;)u.push(s),n.appendChild(s)
if("SELECT"===t.tagName)for(a=u.length;a--;)u[a]!==o&&(u[a].selected=!1)}return u},Od=kr,Ld=xr,Id=Dr,Pd=Ar,Rd=Cr,Nd=Sr,Md=function(e){this.type=Gl,id.init(this,e)}
...
return isNaN(e)?void 0:e}}),rg=li,ig=hi,og=fi,sg=pi,ag=di,ug=/^event(?:\.(.+))?/,lg=yi,cg=bi,hg={},fg={touchstart:!0,touchmove:!0,touchend:!0,touchcancel:!0,touchleave:!0},pg=_i,dg=ki,mg=Ei,gg=xi,vg=Di,yg=function(e,t,n){this.init(e,t,n)}
...
var kg,Eg,xg,Dg=_g,Ag=ji,Cg=Oi,Sg=Mi,Fg=function(e){return e.replace(/-([a-zA-Z])/g,function(e,t){return t.toUpperCase()})}
Xs?(Eg={},xg=ha("div").style,kg=function(e){var t,n,r
...
_a(Uv,e,{value:t})}),Cv={},Cv.__proto__?(Sv=function(e){e.__proto__=Uv},Fv=function(e){e.__proto__=Array.prototype}):(Sv=function(e){var t,n
for(t=zv.length;t--;)n=zv[t],_a(e,n,{value:Uv[n],configurable:!0})},Fv=function(e){var t
for(t=zv.length;t--;)delete e[zv[t]]}),Sv.unpatch=Fv
var Wv,Vv,Hv,Kv=Sv
Wv={filter:function(e){return o(e)&&(!e._ractive||!e._ractive.setting)},wrap:function(e,t,n){return new Vv(e,t,n)}},Vv=function(e,t,n){this.root=e,this.value=t,this.keypath=x(n),t._ractive||(_a(t,"_ractive",{value:{wrappers:[],instances:[],setting:!1},configurable:!0}),Kv(t)),t._ractive.instances[e._guid]||(t._ractive.instances[e._guid]=0,t._ractive.instances.push(e)),t._ractive.instances[e._guid]+=1,t._ractive.wrappers.push(this)},Vv.prototype={get:function(){return this.value},teardown:function(){var e,t,n,r,i
...
var ty=Qv,ny=yo,ry={},iy=_o,oy=ko,sy=Do,ay=Bo,uy=To,ly=function(e,t){this.computation=e,this.viewmodel=e.viewmodel,this.ref=t,this.root=this.viewmodel.ractive,this.parentFragment=this.root.component&&this.root.component.parentFragment}
...
var wy=No,_y=function(e,t){var n,r,i,o
return n={},r=0,i=e.map(function(e,i){var s,a,u
a=r,u=t.length
do{if(s=t.indexOf(e,a),-1===s)return o=!0,-1
a=s+1}while(n[s]&&u>a)
return s===r&&(r+=1),s!==i&&(o=!0),n[s]=!0,s})},ky=Mo,Ey={},xy=zo,Dy=Vo,Ay=Ho,Cy=Ko,Sy=$o,Fy={implicit:!0},By={noCascade:!0},Ty=Zo,jy=Jo,Oy=function(e){var t,n,r=e.adapt,i=e.data,o=e.ractive,s=e.computed,a=e.mappings
...
this.ready=!0}
Oy.prototype={adapt:ny,applyChanges:sy,capture:ay,clearCache:uy,compute:py,get:my,init:vy,map:yy,mark:wy,merge:ky,register:xy,release:Dy,reset:Ay,set:Cy,smartUpdate:Sy,teardown:Ty,unregister:jy}
var Ly=Oy
...
for(t=e.root;t;)(n=t._liveComponentQueries["_"+e.name])&&n.push(e.instance),t=t.parent},$y=gs,Gy=vs,Zy=ys,Jy=bs,Qy=ws,Xy=new nu("teardown"),eb=ks,tb=function(e,t){this.init(e,t)}
...
return new u(this.leveldown.iterator(t),this.prefix)},t.exports=l}).call(this,e("buffer").Buffer)},{"abstract-leveldown":175,buffer:209,"level-option-wrap":178,util:237}],172:[function(e,t,n){arguments[4][15][0].apply(n,arguments)},{_process:217,dup:15}],173:[function(e,t,n){arguments[4][16][0].apply(n,arguments)},{_process:217,dup:16}],174:[function(e,t,n){(function(n,r){function i(e){if(!arguments.length||void 0===e)throw new Error("constructor requires at least a location argument")
if("string"!=typeof e)throw new Error("constructor requires a location string argument")
...
return this._isBuffer(e)||(e=String(e)),this._isBuffer(t)||(t=String(t)),"function"==typeof this._approximateSize?this._approximateSize(e,t,n):void r.nextTick(function(){n(null,0)})},i.prototype._setupIteratorOptions=function(e){var t=this
return e=o(e),["start","end","gt","gte","lt","lte"].forEach(function(n){e[n]&&t._isBuffer(e[n])&&0===e[n].length&&delete e[n]}),e.reverse=!!e.reverse,e.keys=0!=e.keys,e.values=0!=e.values,e.limit="limit"in e?e.limit:-1,e.keyAsBuffer=0!=e.keyAsBuffer,e.valueAsBuffer=0!=e.valueAsBuffer,e},i.prototype.iterator=function(e){return"object"!=typeof e&&(e={}),e=this._setupIteratorOptions(e),"function"==typeof this._iterator?this._iterator(e):new s(this)},i.prototype._chainedBatch=function(){return new a(this)},i.prototype._isBuffer=function(e){return n.isBuffer(e)},i.prototype._checkKey=function(e,t){if(null===e||void 0===e)return new Error(t+" cannot be `null` or `undefined`")
if(this._isBuffer(e)){if(0===e.length)return new Error(t+" cannot be an empty Buffer")}else if(""===String(e))return new Error(t+" cannot be an empty String")},t.exports=i}).call(this,{isBuffer:e("/Users/saibotsivad/Development/npm_global/lib/node_modules/noddity-installer/node_modules/browserify/node_modules/insert-module-globals/node_modules/is-buffer/index.js")},e("_process"))},{"./abstract-chained-batch":172,"./abstract-iterator":173,"/Users/saibotsivad/Development/npm_global/lib/node_modules/noddity-installer/node_modules/browserify/node_modules/insert-module-globals/node_modules/is-buffer/index.js":215,_process:217,xtend:177}],175:[function(e,t,n){n.AbstractLevelDOWN=e("./abstract-leveldown"),n.AbstractIterator=e("./abstract-iterator"),n.AbstractChainedBatch=e("./abstract-chained-batch"),n.isLevelDOWN=e("./is-leveldown")},{"./abstract-chained-batch":172,"./abstract-iterator":173,"./abstract-leveldown":174,"./is-leveldown":176}],176:[function(e,t,n){function r(e){return e&&"object"==typeof e?Object.keys(i.prototype).filter(function(e){return"_"!=e[0]&&"approximateSize"!=e}).every(function(t){return"function"==typeof e[t]}):!1}var i=e("./abstract-leveldown")
...
throw o}t=D(this,t),this.options=h(A,t),this._codec=t.codec||x,this._status="new",f(this,"location",e,"e"),this.open(r)}function o(e,t,n){return e._isOpening()||e.isOpen()?void 0:(S(e,new m("Database is not open"),n),!0)}function s(e,t,n){S(e,new d(t),n)}function a(e,t,n){return S(e,new m(t),n),!0}function u(e){return function(t,n){C()[e](t,n||function(){})}}var l=e("events").EventEmitter,c=e("util").inherits,h=e("xtend"),f=e("prr"),p=e("deferred-leveldown"),d=e("./errors").WriteError,m=e("./errors").ReadError,g=e("./errors").NotFoundError,v=e("./errors").OpenError,y=e("./errors").EncodingError,b=e("./errors").InitializationError,w=e("./read-stream"),_=e("./write-stream"),k=e("./util"),E=e("./batch"),x=e("./codec"),D=k.getOptions,A=k.defaultOptions,C=k.getLevelDOWN,S=k.dispatchError,F=k.isDefined
c(i,l),i.prototype.open=function(e){var t,r,i=this
...
"closing"==this._status&&e?this.once("closed",e):this._isOpening()&&this.once("open",function(){t.close(e)})}},i.prototype.isOpen=function(){return"open"==this._status},i.prototype._isOpening=function(){return"opening"==this._status},i.prototype.isClosed=function(){return/^clos/.test(this._status)},i.prototype.get=function(e,t,n){var i,s=this
if(n=r(t,n),!o(this,t,n)){if(null===e||void 0===e||"function"!=typeof n)return a(this,"get() requires key and callback arguments",n)
t=k.getOptions(this,t),i=this._codec.encodeKey(e,t),t.asBuffer=this._codec.isValueAsBuffer(t),this.db.get(i,t,function(r,i){if(r)return r=/notfound/i.test(r)?new g("Key not found in database ["+e+"]",r):new m(r),S(s,r,n)
...
return this.isOpen()?r.setIterator(t.db.iterator(e)):this.once("ready",function(){r.setIterator(t.db.iterator(e))}),r},i.prototype.keyStream=i.prototype.createKeyStream=function(e){return this.createReadStream(h(e,{keys:!0,values:!1}))},i.prototype.valueStream=i.prototype.createValueStream=function(e){return this.createReadStream(h(e,{keys:!1,values:!0}))},i.prototype.writeStream=i.prototype.createWriteStream=function(e){return new _(h(e),this)},i.prototype.toString=function(){return"LevelUP"},t.exports=i,t.exports.copy=k.copy,t.exports.destroy=u("destroy"),t.exports.repair=u("repair")}).call(this,e("_process"))},{"./batch":180,"./codec":181,"./errors":183,"./read-stream":185,"./util":186,"./write-stream":187,_process:217,"deferred-leveldown":189,events:213,prr:195,util:237,xtend:206}],185:[function(e,t,n){function r(e,t){return this instanceof r?(i.call(this,{objectMode:!0,highWaterMark:e.highWaterMark}),this._waiting=!1,this._options=e,void(this._makeData=t)):new r(e,t)}var i=e("readable-stream").Readable,o=e("util").inherits,s=(e("xtend"),e("./errors").EncodingError)
e("./util")
...
return e}()
t.exports={defaultOptions:f,copy:r,getOptions:i,getLevelDOWN:o,dispatchError:s,isDefined:a}},{"../package.json":207,"./encodings":182,"./errors":183,leveldown:208,"leveldown/package":208,semver:208,xtend:206}],187:[function(e,t,n){(function(n,r){function i(e,t){if(!(this instanceof i))return new i(e,t)
...
for(var t in e)!function(t){r.prototype[t]=function(n){return this.slice(n,n+e[t])[t](0)}}(t)}(),t.exports=r}).call(this,e("buffer").Buffer)},{buffer:209,"readable-stream":205,util:237}],189:[function(e,t,n){(function(n,r){function i(e){s.call(this,"string"==typeof e?e:""),this._db=void 0,this._operations=[]}var o=e("util"),s=e("abstract-leveldown").AbstractLevelDOWN
o.inherits(i,s),i.prototype.setDb=function(e){this._db=e,this._operations.forEach(function(t){e[t.method].apply(e,t.args)})},i.prototype._open=function(e,t){return r.nextTick(t)},i.prototype._operation=function(e,t){return this._db?this._db[e].apply(this._db,t):void this._operations.push({method:e,args:t})},"put get del batch approximateSize".split(" ").forEach(function(e){i.prototype["_"+e]=function(){this._operation(e,arguments)}}),i.prototype._isBuffer=function(e){return n.isBuffer(e)},i.prototype._iterator=function(){throw new TypeError("not implemented")},t.exports=i}).call(this,{isBuffer:e("/Users/saibotsivad/Development/npm_global/lib/node_modules/noddity-installer/node_modules/browserify/node_modules/insert-module-globals/node_modules/is-buffer/index.js")},e("_process"))},{"/Users/saibotsivad/Development/npm_global/lib/node_modules/noddity-installer/node_modules/browserify/node_modules/insert-module-globals/node_modules/is-buffer/index.js":215,_process:217,"abstract-leveldown":192,util:237}],190:[function(e,t,n){arguments[4][41][0].apply(n,arguments)},{_process:217,dup:41}],191:[function(e,t,n){arguments[4][16][0].apply(n,arguments)},{_process:217,dup:16}],192:[function(e,t,n){(function(n,r){function i(e){if(!arguments.length||void 0===e)throw new Error("constructor requires at least a location argument")
if("string"!=typeof e)throw new Error("constructor requires a location string argument")
this.location=e}var o=e("xtend"),s=e("./abstract-iterator"),a=e("./abstract-chained-batch")
i.prototype.open=function(e,t){if("function"==typeof e&&(t=e),"function"!=typeof t)throw new Error("open() requires a callback argument")
return"object"!=typeof e&&(e={}),"function"==typeof this._open?this._open(e,t):void r.nextTick(t)},i.prototype.close=function(e){if("function"!=typeof e)throw new Error("close() requires a callback argument")
...
return this._isBuffer(e)||(e=String(e)),this._isBuffer(t)||(t=String(t)),"function"==typeof this._approximateSize?this._approximateSize(e,t,n):void r.nextTick(function(){n(null,0)})},i.prototype._setupIteratorOptions=function(e){var t=this
return e=o(e),["start","end","gt","gte","lt","lte"].forEach(function(n){e[n]&&t._isBuffer(e[n])&&0===e[n].length&&delete e[n]}),e.reverse=!!e.reverse,e.reverse&&e.lt&&(e.start=e.lt),e.reverse&&e.lte&&(e.start=e.lte),!e.reverse&&e.gt&&(e.start=e.gt),!e.reverse&&e.gte&&(e.start=e.gte),(e.reverse&&e.lt&&!e.lte||!e.reverse&&e.gt&&!e.gte)&&(e.exclusiveStart=!0),e},i.prototype.iterator=function(e){return"object"!=typeof e&&(e={}),e=this._setupIteratorOptions(e),"function"==typeof this._iterator?this._iterator(e):new s(this)},i.prototype._chainedBatch=function(){return new a(this)},i.prototype._isBuffer=function(e){return n.isBuffer(e)},i.prototype._checkKeyValue=function(e,t){if(null===e||void 0===e)return new Error(t+" cannot be `null` or `undefined`")
if(this._isBuffer(e)){if(0===e.length)return new Error(t+" cannot be an empty Buffer")}else if(""===String(e))return new Error(t+" cannot be an empty String")},t.exports.AbstractLevelDOWN=i,t.exports.AbstractIterator=s,t.exports.AbstractChainedBatch=a}).call(this,{isBuffer:e("/Users/saibotsivad/Development/npm_global/lib/node_modules/noddity-installer/node_modules/browserify/node_modules/insert-module-globals/node_modules/is-buffer/index.js")},e("_process"))},{"./abstract-chained-batch":190,"./abstract-iterator":191,"/Users/saibotsivad/Development/npm_global/lib/node_modules/noddity-installer/node_modules/browserify/node_modules/insert-module-globals/node_modules/is-buffer/index.js":215,_process:217,xtend:206}],193:[function(e,t,n){arguments[4][21][0].apply(n,arguments)},{dup:21,prr:195}],194:[function(e,t,n){arguments[4][22][0].apply(n,arguments)},{"./custom":193,dup:22}],195:[function(e,t,n){arguments[4][23][0].apply(n,arguments)},{dup:23}],196:[function(e,t,n){arguments[4][26][0].apply(n,arguments)},{"./_stream_readable":198,"./_stream_writable":200,_process:217,"core-util-is":201,dup:26,inherits:202}],197:[function(e,t,n){arguments[4][27][0].apply(n,arguments)},{"./_stream_transform":199,"core-util-is":201,dup:27,inherits:202}],198:[function(e,t,n){(function(n){function r(t,n){t=t||{}
...
var o=["error","close","destroy","pause","resume"]
return _(o,function(t){e.on(t,r.emit.bind(r,t))}),r._read=function(t){n&&(n=!1,e.resume())},r},i._fromList=b}).call(this,e("_process"))},{_process:217,buffer:209,"core-util-is":201,events:213,inherits:202,isarray:203,stream:233,"string_decoder/":204}],199:[function(e,t,n){function r(e,t){this.afterTransform=function(e,n){return i(t,e,n)},this.needTransform=!1,this.transforming=!1,this.writecb=null,this.writechunk=null}function i(e,t,n){var r=e._transformState
r.transforming=!1
var i=r.writecb
if(!i)return e.emit("error",new Error("no writecb in Transform class"))
...
"function"==typeof e?(n=e,e=null,t=null):"function"==typeof t&&(n=t,t=null),"undefined"!=typeof e&&null!==e&&this.write(e,t),r.ending||r.finished||b(this,r,n)}}).call(this,e("_process"))},{"./_stream_duplex":196,_process:217,buffer:209,"core-util-is":201,inherits:202,stream:233}],201:[function(e,t,n){arguments[4][31][0].apply(n,arguments)},{"/Users/saibotsivad/Development/npm_global/lib/node_modules/noddity-installer/node_modules/browserify/node_modules/insert-module-globals/node_modules/is-buffer/index.js":215,dup:31}],202:[function(e,t,n){arguments[4][25][0].apply(n,arguments)},{dup:25}],203:[function(e,t,n){arguments[4][9][0].apply(n,arguments)},{dup:9}],204:[function(e,t,n){arguments[4][33][0].apply(n,arguments)},{buffer:209,dup:33}],205:[function(e,t,n){var r=e("stream")
...
readmeFilename:"README.md",bugs:{url:"https://github.com/rvagg/node-levelup/issues"},_id:"levelup@0.19.0",_from:"levelup@>=0.19.0 <0.20.0"}},{}],208:[function(e,t,n){},{}],209:[function(e,t,n){(function(t){function r(){function e(){}try{var t=new Uint8Array(1)
...
var ee=/[^+\/0-9A-Za-z-_]/g}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"base64-js":210,ieee754:211,"is-array":212}],210:[function(e,t,n){var r="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"
...
e.toByteArray=n,e.fromByteArray=i}("undefined"==typeof n?this.base64js={}:n)},{}],211:[function(e,t,n){n.read=function(e,t,n,r,i){var o,s,a=8*i-r-1,u=(1<<a)-1,l=u>>1,c=-7,h=n?i-1:0,f=n?-1:1,p=e[t+h]
...
for(t=Math.abs(t),isNaN(t)||t===1/0?(a=isNaN(t)?1:0,s=c):(s=Math.floor(Math.log(t)/Math.LN2),t*(u=Math.pow(2,-s))<1&&(s--,u*=2),t+=s+h>=1?f/u:f*Math.pow(2,1-h),t*u>=2&&(s++,u/=2),s+h>=c?(a=0,s=c):s+h>=1?(a=(t*u-1)*Math.pow(2,i),s+=h):(a=t*Math.pow(2,h-1)*Math.pow(2,i),s=0));i>=8;e[n+p]=255&a,p+=d,a/=256,i-=8);for(s=s<<i|a,l+=i;l>0;e[n+p]=255&s,p+=d,s/=256,l-=8);e[n+p-d]|=128*m}},{}],212:[function(e,t,n){var r=Array.isArray,i=Object.prototype.toString
t.exports=r||function(e){return!!e&&"[object Array]"==i.call(e)}},{}],213:[function(e,t,n){function r(){this._events=this._events||{},this._maxListeners=this._maxListeners||void 0}function i(e){return"function"==typeof e}function o(e){return"number"==typeof e}function s(e){return"object"==typeof e&&null!==e}function a(e){return void 0===e}t.exports=r,r.EventEmitter=r,r.prototype._events=void 0,r.prototype._maxListeners=void 0,r.defaultMaxListeners=10,r.prototype.setMaxListeners=function(e){if(!o(e)||0>e||isNaN(e))throw TypeError("n must be a positive number")
...
return n=e._events&&e._events[t]?i(e._events[t])?1:e._events[t].length:0}},{}],214:[function(e,t,n){arguments[4][25][0].apply(n,arguments)},{dup:25}],215:[function(e,t,n){t.exports=function(e){return!(null==e||!(e._isBuffer||e.constructor&&"function"==typeof e.constructor.isBuffer&&e.constructor.isBuffer(e)))}},{}],216:[function(e,t,n){arguments[4][9][0].apply(n,arguments)},{dup:9}],217:[function(e,t,n){function r(){c=!1,a.length?l=a.concat(l):h=-1,l.length&&i()}function i(){if(!c){var e=setTimeout(r)
c=!0
...
return e>65535&&(e-=65536,t+=P(e>>>10&1023|55296),e=56320|1023&e),t+=P(e)}).join("")}function l(e){return 10>e-48?e-22:26>e-65?e-65:26>e-97?e-97:k}function c(e,t){return e+22+75*(26>e)-((0!=t)<<5)}function h(e,t,n){var r=0
for(e=n?I(e/A):e>>1,e+=I(e/t);e>L*x>>1;r+=k)e=I(e/L)
...
for(o=n>0?n+1:0;g>o;){for(s=v,a=1,c=k;o>=g&&i("invalid-input"),f=l(e.charCodeAt(o++)),(f>=k||f>I((_-v)/a))&&i("overflow"),v+=f*a,p=b>=c?E:c>=b+x?x:c-b,!(p>f);c+=k)d=k-p,a>I(_/d)&&i("overflow"),a*=d
t=m.length+1,b=h(v-s,t,0==s),I(v/t)>_-y&&i("overflow"),y+=I(v/t),v%=t,m.splice(v++,0,y)}return u(m)}function p(e){var t,n,r,o,s,u,l,f,p,d,m,g,v,y,b,w=[]
for(e=a(e),g=e.length,t=S,n=0,s=C,u=0;g>u;++u)m=e[u],128>m&&w.push(P(m))
for(r=o=w.length,o&&w.push(F);g>r;){for(l=_,u=0;g>u;++u)m=e[u],m>=t&&l>m&&(l=m)
for(v=r+1,l-t>I((_-n)/v)&&i("overflow"),n+=(l-t)*v,t=l,u=0;g>u;++u)if(m=e[u],t>m&&++n>_&&i("overflow"),m==t){for(f=n,p=k;d=s>=p?E:p>=s+x?x:p-s,!(d>f);p+=k)b=f-d,y=k-d,w.push(P(c(d+b%y,0))),f=I(b/y)
...
var b,w,_=2147483647,k=36,E=1,x=26,D=38,A=700,C=72,S=128,F="-",B=/^xn--/,T=/[^\x20-\x7E]/,j=/[\x2E\u3002\uFF0E\uFF61]/g,O={overflow:"Overflow: input needs wider integers to process","not-basic":"Illegal input >= 0x80 (not a basic code point)","invalid-input":"Invalid input"},L=k-E,I=Math.floor,P=String.fromCharCode
...
n.decode=n.parse=e("./decode"),n.encode=n.stringify=e("./encode")},{"./decode":219,"./encode":220}],222:[function(e,t,n){t.exports=e("./lib/_stream_duplex.js")},{"./lib/_stream_duplex.js":223}],223:[function(e,t,n){arguments[4][26][0].apply(n,arguments)},{"./_stream_readable":225,"./_stream_writable":227,_process:217,"core-util-is":228,dup:26,inherits:214}],224:[function(e,t,n){arguments[4][27][0].apply(n,arguments)},{"./_stream_transform":226,"core-util-is":228,dup:27,inherits:214}],225:[function(e,t,n){arguments[4][28][0].apply(n,arguments)},{"./_stream_duplex":223,_process:217,buffer:209,"core-util-is":228,dup:28,events:213,inherits:214,isarray:216,stream:233,"string_decoder/":234,util:208}],226:[function(e,t,n){arguments[4][29][0].apply(n,arguments)},{"./_stream_duplex":223,"core-util-is":228,dup:29,inherits:214}],227:[function(e,t,n){arguments[4][30][0].apply(n,arguments)},{"./_stream_duplex":223,_process:217,buffer:209,"core-util-is":228,dup:30,inherits:214,stream:233}],228:[function(e,t,n){arguments[4][31][0].apply(n,arguments)},{"/Users/saibotsivad/Development/npm_global/lib/node_modules/noddity-installer/node_modules/browserify/node_modules/insert-module-globals/node_modules/is-buffer/index.js":215,dup:31}],229:[function(e,t,n){t.exports=e("./lib/_stream_passthrough.js")},{"./lib/_stream_passthrough.js":224}],230:[function(e,t,n){arguments[4][34][0].apply(n,arguments)},{"./lib/_stream_duplex.js":223,"./lib/_stream_passthrough.js":224,"./lib/_stream_readable.js":225,"./lib/_stream_transform.js":226,"./lib/_stream_writable.js":227,dup:34,stream:233}],231:[function(e,t,n){t.exports=e("./lib/_stream_transform.js")},{"./lib/_stream_transform.js":226}],232:[function(e,t,n){t.exports=e("./lib/_stream_writable.js")},{"./lib/_stream_writable.js":227}],233:[function(e,t,n){function r(){i.call(this)}t.exports=r
...
var c=!1
return l.on("error",a),e.on("error",a),l.on("end",u),l.on("close",u),e.on("close",u),e.emit("pipe",l),e}},{events:213,inherits:214,"readable-stream/duplex.js":222,"readable-stream/passthrough.js":229,"readable-stream/readable.js":230,"readable-stream/transform.js":231,"readable-stream/writable.js":232}],234:[function(e,t,n){arguments[4][33][0].apply(n,arguments)},{buffer:209,dup:33}],235:[function(e,t,n){function r(){this.protocol=null,this.slashes=null,this.auth=null,this.host=null,this.port=null,this.hostname=null,this.hash=null,this.search=null,this.query=null,this.pathname=null,this.path=null,this.href=null}function i(e,t,n){if(e&&l(e)&&e instanceof r)return e
var i=new r
...
var p=/^([a-z0-9.+-]+:)/i,d=/:[0-9]*$/,m=["<",">",'"',"`"," ","\r","\n","	"],g=["{","}","|","\\","^","`"].concat(m),v=["'"].concat(g),y=["%","/","?",";","#"].concat(v),b=["/","?","#"],w=255,_=/^[a-z0-9A-Z_-]{0,63}$/,k=/^([a-z0-9A-Z_-]{0,63})(.*)$/,E={javascript:!0,"javascript:":!0},x={javascript:!0,"javascript:":!0},D={http:!0,https:!0,ftp:!0,gopher:!0,file:!0,"http:":!0,"https:":!0,"ftp:":!0,"gopher:":!0,"file:":!0},A=e("querystring")
...
if(S&&!S.match(_)){for(var F="",B=0,T=S.length;T>B;B++)F+=S.charCodeAt(B)>127?"x":S[B]
if(!F.match(_)){var j=g.slice(0,l),O=g.slice(l+1),L=S.match(k)
...
var g=n.host&&n.host.indexOf("@")>0?n.host.split("@"):!1
g&&(n.auth=g.shift(),n.host=n.hostname=g.shift())}return f=f||n.host&&d.length,f&&!_&&d.unshift(""),d.length?n.pathname=d.join("/"):(n.pathname=null,n.path=null),c(n.pathname)&&c(n.search)||(n.path=(n.pathname?n.pathname:"")+(n.search?n.search:"")),n.auth=e.auth||n.auth,n.slashes=n.slashes||e.slashes,n.href=n.format(),n},r.prototype.parseHost=function(){var e=this.host,t=d.exec(e)
t&&(t=t[0],":"!==t&&(this.port=t.substr(1)),e=e.substr(0,e.length-t.length)),e&&(this.hostname=e)}},{punycode:218,querystring:221}],236:[function(e,t,n){t.exports=function(e){return e&&"object"==typeof e&&"function"==typeof e.copy&&"function"==typeof e.fill&&"function"==typeof e.readUInt8}},{}],237:[function(e,t,n){(function(t,r){function i(e,t){var r={seen:[],stylize:s}
...
v=" [Function"+_+"]"}if(k(t)&&(v=" "+RegExp.prototype.toString.call(t)),x(t)&&(v=" "+Date.prototype.toUTCString.call(t)),D(t)&&(v=" "+c(t)),0===s.length&&(!y||0==t.length))return w[0]+v+w[1]
if(0>r)return k(t)?e.stylize(RegExp.prototype.toString.call(t),"regexp"):e.stylize("[Object]","special")
e.seen.push(t)
var E
return E=y?h(e,t,r,m,s):s.map(function(n){return f(e,t,r,m,n,y)}),e.seen.pop(),p(E,v,w)}function l(e,t){if(_(t))return e.stylize("undefined","undefined")
...
return i>60?n[0]+(""===t?"":t+"\n ")+" "+e.join(",\n  ")+" "+n[1]:n[0]+t+" "+e.join(", ")+" "+n[1]}function d(e){return Array.isArray(e)}function m(e){return"boolean"==typeof e}function g(e){return null===e}function v(e){return null==e}function y(e){return"number"==typeof e}function b(e){return"string"==typeof e}function w(e){return"symbol"==typeof e}function _(e){return void 0===e}function k(e){return E(e)&&"[object RegExp]"===S(e)}function E(e){return"object"==typeof e&&null!==e}function x(e){return E(e)&&"[object Date]"===S(e)}function D(e){return E(e)&&("[object Error]"===S(e)||e instanceof Error)}function A(e){return"function"==typeof e}function C(e){return null===e||"boolean"==typeof e||"number"==typeof e||"string"==typeof e||"symbol"==typeof e||"undefined"==typeof e}function S(e){return Object.prototype.toString.call(e)}function F(e){return 10>e?"0"+e.toString(10):e.toString(10)}function B(){var e=new Date,t=[F(e.getHours()),F(e.getMinutes()),F(e.getSeconds())].join(":")
...
return e}}).call(this,e("_process"),"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./support/isBuffer":236,_process:217,inherits:214}]},{},[2])
