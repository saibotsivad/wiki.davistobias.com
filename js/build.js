...
t.createKeyStream().on("data",function(e){t.del(e)})}}},{levelup:20,"localstorage-down":44}],2:[function(t){var e=t("noddity-butler"),n=t("levelup"),r=t("noddity-linkifier"),i=t("localstorage-down"),o=t("./routing"),a=t("./mainViewModel"),s=t("level-sublevel"),u=noddityConfig,c=function(t){return new i(t)},h=s(n("noddity-content-2",{db:c})),l=u.title.replace(/[^\w]+/g,""),f=u.debug?{refreshEvery:3e4}:void 0,p=new e(u.noddityRoot,h.sublevel(l),f),d=new r(u.pathPrefix+u.pagePathPrefix),g=new a(p,d),v=o()
...
e+=r.slice(0,n).toString(i)}return e}},{buffer:80}],41:[function(t,e,n){var r=t("stream")
...
return c.unref&&c.unref(),a.touch=a.emit.bind(a,"touch"),a.forget=a.emit.bind(a,"forget"),a.stop=function(){clearInterval(c)},a}},{events:84}],63:[function(t,e){var n=function(){"use strict"
...
var l,f,p,d,g,v=!1,m=!1,y=0,b=null,w=[],E=[],_=[],x=[],k=[],S=[],O=[],T=[],A=[],N={},L=[],R=[],C=[],j=[]
return l={start:function(t,e){this.addInstance(t),m||(y+=1,g=s(e,g))},end:function(){return m?void h():(--y||(m=!0,c(),m=!1,u()),g.init(),void(g=g._previous))},trigger:function(){return y||m?void h():(m=!0,c(),m=!1,void u())},focus:function(t){b=t},addInstance:function(t){t&&!j[t._guid]&&(j.push(t),j[j._guid]=!0)},addLiveQuery:function(t){w.push(t)},addDecorator:function(t){E.push(t)},addTransition:function(t){t._manager=g,g.push(t),_.push(t)},addObserver:function(t){x.push(t)},addAttribute:function(t){k.push(t)},addBinding:function(t){t.active=!0,S.push(t)},scheduleCssUpdate:function(){y||m?d=!0:e.update()},addEvaluator:function(t){v=!0,O.push(t)},addComputation:function(t){v=!0,T.push(t)},addSelectValue:function(t){v=!0,A.push(t)},addCheckbox:function(t){N[t.keypath]||(v=!0,L.push(t))},addRadio:function(t){v=!0,R.push(t)},addUnresolved:function(t){v=!0,C.push(t)},removeUnresolved:function(t){n(C,t)},detachWhenReady:function(t){g.detachQueue.push(t)}},t.runloop=l,l}(w,_,E,x,O,T,A,N),R=function(t,e,n){var r=[],i={tick:function(){var o,a,s
...
return n}}(C),I={},P=function(t,e,n){switch(e){case"splice":return n
...
l=i.adapt[h]=t[l]}if(l.filter(s,a,i))return f=i._wrapped[a]=l.wrap(i,s,a,o(a)),f.value=s,s}return u||(i.magic?r.filter(s,a,i)?i._wrapped[a]=r.wrap(i,s,a):n.filter(s,a,i)&&(i._wrapped[a]=n.wrap(i,s,a)):i.modifyArrays&&e.filter(s,a,i)&&(i._wrapped[a]=e.wrap(i,s,a))),s}}(I,V,z,H),K=function(){function t(t,e){var n,r,i
...
return s=i.split("."),u=s.pop(),c=s.join("."),h=a(t,c),(p=t._wrapped[c])&&(h=p.get()),null!==h&&void 0!==h?((l=t._cacheMap[c])?-1===l.indexOf(i)&&l.push(i):t._cacheMap[c]=[i],"object"!=typeof h||u in h?(d=!e.call(h,u),f=d?n(h[u]):h[u],f=r(t,i,f,!1),t._cache[i]=f,f):t._cache[i]=o):void 0}return t.get=a,a}(w,k,j,$,J,Q),Z=function(){return"undefined"!=typeof console&&"function"==typeof console.warn&&"function"==typeof console.warn.apply?function(){console.warn.apply(console,arguments)}:function(){}}(),te=function(){var t=Object.prototype.toString
...
return i.prototype={update:n.update,resolve:n.resolve,reassign:n.reassign,render:function(t){this.value=t,this.parentFragment.bubble()},teardown:function(){e(this)},toString:function(){return void 0==this.value?"":r(this.value)}},i}(D,He,nn),jn=function(t,e,n,r,i){var o,a
...
return r=this.remaining(),i=this.inside?"</"+this.inside:"<",(n=this.inside&&!this.interpolate[this.inside]?r.indexOf(i):e(r,[i,this.delimiters[0],this.tripleDelimiters[0]]))?(-1===n&&(n=r.length),this.pos+=n,{type:t.TEXT,value:r.substr(0,n)}):null}}(D,Lr),jr=function(t){return function(e){var n=e.remaining()
return"true"===n.substr(0,4)?(e.pos+=4,{t:t.BOOLEAN_LITERAL,v:"true"}):"false"===n.substr(0,5)?(e.pos+=5,{t:t.BOOLEAN_LITERAL,v:"false"}):null}}(D),Ir=function(t,e){return function(n){var r,i,o
...
return a}}(An,jr,Tn,Mr,Fr),Ur=function(t,e,n){var r,i,o,a
...
return n.prototype={detach:e,teardown:function(t){t&&this.detach()},firstNode:function(){return this.node},toString:function(){return"<!--"+this.descriptor.f+"-->"}},n}(D,Ve),ji=function(t,e,n,r,i,o,a,s,u,c,h,l,f){var p=function(t){t.pNode&&(this.docFrag=document.createDocumentFragment()),"string"==typeof t.descriptor?(this.html=t.descriptor,this.docFrag&&(this.nodes=r(this.html,t.pNode.tagName,t.pNode.namespaceURI,this.docFrag))):n.init(this,t)}
...
return r=n.split(",").map(t),i=r.map(u).join(", ")+" ",e.replace(n,i)})}}(),Qi=function(t,e,n,r){return function(i,o){t.forEach(function(t){o[t]&&(i[t]=e(o[t]))}),n(i,"defaults",{value:e(o.defaults)}),o.css&&n(i,"css",{value:o.defaults.noCssTransform?o.css:r(o.css,i._guid)})}}(Yi,Ie,c,Ji),Xi=function(t,e){return/_super/.test(t)?function(){var n,r=this._super
...
return n=n.replace(/^\n+/,""),n=n.replace(/\n+$/g,""),n="\n\n~K"+(M.push(n)-1)+"K\n\n"}function o(t,n){t=j.preBlockGamut(t,F),t=p(t)
var r="<hr />\n"
return t=t.replace(/^[ ]{0,2}([ ]?\*[ ]?){3,}[ \t]*$/gm,r),t=t.replace(/^[ ]{0,2}([ ]?-[ ]?){3,}[ \t]*$/gm,r),t=t.replace(/^[ ]{0,2}([ ]?_[ ]?){3,}[ \t]*$/gm,r),t=d(t),t=v(t),t=E(t),t=j.postBlockGamut(t,F),t=e(t),t=_(t,n)}function a(t){return t=j.preSpanGamut(t),t=y(t),t=s(t),t=k(t),t=h(t),t=u(t),t=O(t),t=t.replace(/~P/g,"://"),t=x(t),t=w(t),t=t.replace(/  +\n/g," <br>\n"),t=j.postSpanGamut(t)}function s(t){var e=/(<[a-z\/!$]("[^"]*"|'[^']*'|[^'">])*>|<!(--(?:|(?:[^>-]|-[^>])(?:[^-]|-[^-])*)--)>)/gi
...
if(""==f)if(""==h&&(h=c.toLowerCase().replace(/ ?\n/g," ")),f="#"+h,void 0!=I.get(h))f=I.get(h),void 0!=P.get(h)&&(p=P.get(h))
...
f=I.get(h),void 0!=P.get(h)&&(p=P.get(h))}c=R(l(c),"*_[]()"),f=R(f,"*_")
...
if("string"!=typeof n||!t(r))throw new Error("Bad arguments")
if(i=+e.get(n)||0,!t(i))throw new Error("Cannot add to a non-numeric value")
return e.set(n,i+r)}}(c),C=function(t){return function(e,n){return t(this,e,void 0===n?1:+n)}}(R),j=function(t){var e=/^\.+/
...
return f=f.concat(t),f.length||"string"!=typeof l?(e={n:1===l.length&&"string"==typeof l[0]?l[0]:l},1===f.length&&"string"==typeof f[0]?(p=r("["+f[0]+"]"),e.a=p?p.value:f[0].trim()):e.d=f):e=l,e}}(ve,de,ge,Re),je=function(t,e,n,r,i,o,a,s){function u(n){var r,i,o,u,h,f,w,E,_,x,k
...
y&&y.stop()},i}return r=r||{},r.complete&&i.then(r.complete),r.complete=a,c=o(this,t,n,r),i.stop=function(){c.stop()},i}}(y,g,j,D,Ye),Qe=function(t){return function(){return this.detached?this.detached:(this.el&&t(this.el.__ractive_instances__,this),this.detached=this.fragment.detach(),this.detached)}}(d),Xe=function(t){return this.el?this.fragment.find(t):null},Ze=function(t,e,n){var r,i,o,a,s,u,c,h
...
return function(n){return n=t(n),this.viewmodel.get(n,e)}}(j),dn=function(t){var e
...
return i}(_,ji,Ci,Si),Pi=function(t,e){var n=t.extend({render:function(){this.element.node.addEventListener("change",e,!1)},unrender:function(){this.element.node.removeEventListener("change",e,!1)},getValue:function(){return this.element.node.files}})
...
return function(t){var n
return t?(e.test(t)&&(t="-"+t),n=t.replace(/[A-Z]/g,function(t){return"-"+t.toLowerCase()})):""}}(I),mo=function(t,e,n,r,i,o,a,s,u){var c,h,l,f,p,d,g,v,m={},y={}
...
default:throw new Error("Something very strange happened. Please file an issue at https://github.com/ractivejs/ractive/issues. Thanks!")}}}(z,Kn,hr,Tr,Ur,No,jo,Io,ea,na,ra),oa=function(t,e,n){return function(r){var i,o,a,s=this
...
return t.end(),s&&c.then(s.bind(this)),c}}(_,u,j,yn),va=function(t){return t("shift")}(Nn),ma=function(t){return t("sort")}(Nn),ya=function(t){return t("splice")}(Nn),ba=function(t){return function(e,n){return t(this,e,void 0===n?-1:-n)}}(R),wa=function(t,e,n){return function(r){var i
...
return"string"!=typeof t&&(t="",e=!0),n(this,t,r={},e),this.set(r)}}(ji,y),Ta=function(t,e,n,r,i,o,a,s,u,c,h,l,f,p,d,g,v,m,y,b,w,E,_,x,k,S,O,T,A,N,L,R){return{add:t,animate:e,detach:n,find:r,findAll:i,findAllComponents:o,findComponent:a,fire:s,get:u,insert:c,merge:h,observe:l,off:f,on:p,pop:d,push:g,render:v,reset:m,resetTemplate:y,reverse:b,set:w,shift:E,sort:_,splice:x,subtract:k,teardown:S,toggle:O,toHTML:T,unrender:A,unshift:N,update:L,updateModel:R}}(C,Je,Qe,Xe,cn,hn,ln,fn,pn,gn,vn,_n,Sn,On,Ln,Rn,jn,fa,pa,da,ga,va,ma,ya,ba,wa,Ea,_a,xa,ka,Sa,Oa),Aa=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(t){var e,n
...
if(a=r.indexOf(this),-1===a)throw new Error(o)
if(r.splice(a,1),r.length){if(i[this.root._guid]-=1,!i[this.root._guid]){if(a=i.indexOf(this.root),-1===a)throw new Error(o)
i.splice(a,1)}}else delete t._ractive,n.unpatch(this.value)}},o="Something went wrong in a rather interesting way",r}(N,s,Ra),ja=function(t,e){var n,r
return t&&(n={filter:function(n,r,i){return t.filter(n,r,i)&&e.filter(n)},wrap:function(t,e,n){return new r(t,e,n)}},r=function(n,r,i){this.value=r,this.magic=!0,this.magicWrapper=t.wrap(n,r,i),this.arrayWrapper=e.wrap(n,r,i)},r.prototype={get:function(){return this.value},teardown:function(){this.arrayWrapper.teardown(),this.magicWrapper.teardown()},reset:function(t){return this.magicWrapper.reset(t)}}),n}(k,Ca),Ia=function(t,e,n,r){function i(t,e){var n,r={}
if(!e)return t
e+="."
for(n in t)t.hasOwnProperty(n)&&(r[e+n]=t[n])
return r}function o(t){var e
...
c=l.adapt[u]=f}if(c.filter(a,i,l))return h=this.wrapped[i]=c.wrap(l,a,i,o(i)),h.value=a,a}return l.magic?r.filter(a,i,l)?this.wrapped[i]=r.wrap(l,a,i):n.filter(a,i,l)&&(this.wrapped[i]=n.wrap(l,a,i)):l.modifyArrays&&e.filter(a,i,l)&&(this.wrapped[i]=e.wrap(l,a,i)),a}}(Ke,Ca,k,ja),Pa=function(t){var e,n,r,i,o=[""]
...
return i}function h(t,e,n){return j.fromByteArray(0===e&&n===t.length?t:t.slice(e,n))}function l(t,e,n){var r="",i=""
...
if(n+r>t.length)throw new TypeError("index out of range")}function E(t,e,n,r,i){return i||w(t,e,n,4,3.4028234663852886e38,-3.4028234663852886e38),I.write(t,e,n,r,23,4),n+4}function _(t,e,n,r,i){return i||w(t,e,n,8,1.7976931348623157e308,-1.7976931348623157e308),I.write(t,e,n,r,52,8),n+8}function x(t){for(t=k(t).replace(F,"");t.length%4!==0;)t+="="
...
return i}function L(t){return j.toByteArray(t)}function R(t,e,n,r){for(var i=0;r>i&&!(i+n>=e.length||i>=t.length);i++)e[i+n]=t[i]
return i}function C(t){try{return decodeURIComponent(t)}catch(e){return String.fromCharCode(65533)}}var j=t("base64-js"),I=t("ieee754"),P=t("is-array")
...
r()}},!0),function(t){n.push(t),window.postMessage("process-tick","*")}}return function(t){setTimeout(t,0)}}(),r.title="browser",r.browser=!0,r.env={},r.argv=[],r.on=n,r.addListener=n,r.once=n,r.off=n,r.removeListener=n,r.removeAllListeners=n,r.emit=n,r.binding=function(){throw new Error("process.binding is not supported")},r.cwd=function(){return"/"},r.chdir=function(){throw new Error("process.chdir is not supported")}},{}],91:[function(t,e,n){(function(t){!function(r){function i(t){throw RangeError(j[t])}function o(t,e){for(var n=t.length;n--;)t[n]=e(t[n])
...
return P(r+(I+1)*t/(t+S))}function f(t){var e,n,r,o,a,s,h,f,p,d,g=[],v=t.length,m=0,y=A,b=T
...
var b,w,E=2147483647,_=36,x=1,k=26,S=38,O=700,T=72,A=128,N="-",L=/^xn--/,R=/[^ -~]/,C=/\x2E|\u3002|\uFF0E|\uFF61/g,j={overflow:"Overflow: input needs wider integers to process","not-basic":"Illegal input >= 0x80 (not a basic code point)","invalid-input":"Invalid input"},I=_-x,P=Math.floor,M=String.fromCharCode
...
if(!N.match(E)){var C=v.slice(0,c),j=v.slice(c+1),I=A.match(_)
I&&(C.push(I[1]),j.unshift(I[2])),j.length&&(r="/"+j.join(".")+r),this.hostname=C.join(".")
